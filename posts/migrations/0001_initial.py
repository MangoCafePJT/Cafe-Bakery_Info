# Generated by Django 3.2.18 on 2023-04-30 17:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=13, validators=[django.core.validators.RegexValidator(regex='^0(2|[1-9][0-9])-?\\d{3,4}-?\\d{4}$')])),
